    ...
    <>
      ...
      >
        <Link href={`/movie/${movie.id}`} ref={ref} {...longPress()}>
          {variant === "full" && (
            <div className="group motion-preset-focus relative aspect-2/3 w-[140px] overflow-hidden rounded-xl border-[3px] border-transparent text-white shadow-md transition-all duration-200 hover:border-primary hover:shadow-xl active:scale-[0.98] sm:w-[155px] md:w-[170px] lg:w-[185px]">
              {hovered && (
                <Icon
