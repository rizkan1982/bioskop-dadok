...
export default function ScrollingNotice({ 
  ...
  return (
    <div className={`${className} bg-gradient-to-r from-red-600 via-red-700 to-red-600 
      text-white py-3 overflow-hidden relative`}>
      ...
      <div className="relative animate-marquee whitespace-nowrap">
        <div className="inline-flex items-center gap-8 px-4">
          {/* Badge ATTENTION */}
          <span className="inline-flex items-center gap-2 bg-white text-red-600 
            px-3 py-1 rounded font-bold text-sm uppercase tracking-wide">
